  ...
  return (
    <>
        ...
        >
          <div className="space-y-5">
            <div className="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
              <h4 className="mb-3 font-semibold text-gray-900 dark:text-white">{t('dictRequest.programmer_title')}</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                {t('dictRequest.programmer_description')}
                <a
                  ...
                  rel="noreferrer"
                >
                  {t('dictRequest.contribution_guide')}
                </a>
                {t('dictRequest.programmer_suffix')}
              </p>
            </div>

            <div className="rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 p-4 shadow-sm dark:from-gray-800 dark:to-gray-700">
              <h4 className="mb-3 font-semibold text-gray-900 dark:text-white">{t('dictRequest.try_title')}</h4>
              <p className="mb-3 text-sm text-gray-600 dark:text-gray-300">
                {t('dictRequest.try_description')}
                <br />
                <div className="my-2"></div>
                {t('dictRequest.try_recommendation')}
              </p>
      ...
      >
        ...
        <span>{t('dictRequest.button')}</span>
